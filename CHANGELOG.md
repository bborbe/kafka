...
- Remove encoding.TextMarshaler support for Broker type
- Remove encoding.TextMarshaler support for Brokers type
- Remove comprehensive test coverage for MarshalText methods
